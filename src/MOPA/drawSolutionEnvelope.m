function [v1,v2] = drawSolutionEnvelope(models,rxnId1,rxnId2,NSteps,plotFlag,lgd,rxnWgt1,rxnWgt2)
...
%   drawSolutionEnvelope(models,'BIOMASS_SC5_notrace','EX_succ_e',20,true);
% 
% INPUTS:
% 
